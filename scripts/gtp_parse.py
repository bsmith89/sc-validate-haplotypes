...
def snp_dict_lookup(fpath, gtp_array, v2, out="/dev/stdout"):
    ...
    with open(fpath, "r") as fh:
        for line in fh:
            ...
            while sp_id > gtp_array[gtp_i][0] or (
                sp_id == gtp_array[gtp_i][0] and pos > gtp_array[gtp_i][1]
            ):
                gtp_i = gtp_i + 1
                if gtp_i >= len(gtp_array):
                    break
            ...
            if sp_id == gtp_array[gtp_i][0] and pos == gtp_array[gtp_i][1]:
                ...
                if v2 is False:
                    ...
                    if gtp_i == len(gtp_array) - 1:
                        ...
                        if (
                            gtp_array[gtp_i][0] == gtp_array[gtp_i + 1][0]
                            and gtp_array[gtp_i][1] == gtp_array[gtp_i + 1][1]
                        ):
